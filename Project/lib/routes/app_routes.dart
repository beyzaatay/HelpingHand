...
import 'package:helpinghand/presentation/main_sifre_one_screen/main_sifre_one_screen.dart';
import 'package:helpinghand/presentation/main_sifre_two_screen/main_sifre_two_screen.dart';
import 'package:helpinghand/presentation/main_kayit_one_screen/main_kayit_one_screen.dart';
import 'package:helpinghand/presentation/main_anasayfa_one_container_screen/main_anasayfa_one_container_screen.dart';
import 'package:helpinghand/presentation/main_anasayfa_two_screen/main_anasayfa_two_screen.dart';
import 'package:helpinghand/presentation/main_anasayfa_four_screen/main_anasayfa_four_screen.dart';
import 'package:helpinghand/presentation/main_profil_two_screen/main_profil_two_screen.dart';
import 'package:helpinghand/presentation/main_profil_three_screen/main_profil_three_screen.dart';
...
class AppRoutes {
  ...
  static const String mainKayitOneScreen = '/main_kayit_one_screen';
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    mainSifreOneScreen: (context) => MainSifreOneScreen(),
    mainSifreTwoScreen: (context) => MainSifreTwoScreen(),
    mainKayitOneScreen: (context) => MainKayitOneScreen(),
